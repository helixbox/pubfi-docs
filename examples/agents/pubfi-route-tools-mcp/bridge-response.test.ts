...
import { exactDirectMcpResponse } from './bridge-response.ts';

void test('stdio bridge preserves the exact direct discovery Registry identity', () => {
  const direct = {
    jsonrpc: '2.0',
    id: 1,
    result: {
...
void test('stdio bridge preserves the exact direct four-tool list and Registry identity', () => {
  const direct = {
    jsonrpc: '2.0',
    id: 2,
    result: {
