...
These surfaces may contain public source-selection and route-planning context. They must not expose
private dashboard state, credentials, account usage, billing records, procurement notes, production
`seo_geo` rows, or raw answer-engine outputs.
