...
and the generated generic World Bank population indicator route. Generic manifest certification
remains a closed gate until a route has the same public readiness evidence as a provider adapter.
